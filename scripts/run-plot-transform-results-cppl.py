...
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/jc/ --modelN jc --datasetName M336 --datasetIdent sub-jc --filename tree-inference --lstP 100 1000 10000 --numruns 30 &
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/gtr/ --modelN gtr --datasetName M336 --datasetIdent gtr --filename tree-inference-gtr --lstP 100 1000 10000 --numruns 30 &

# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/gtr/ --modelN gtr --datasetName primates --datasetIdent gtr --filename tree-inference-gtr --lstP 100 1000 10000 --numruns 30 &
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/gtr/ --modelN gtr --datasetName toy --datasetIdent gtr --filename tree-inference-gtr --lstP 100 1000 10000 --numruns 30 &
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/jc/ --modelN jc --datasetName primates --filename tree-inference --lstP 100 1000 10000 --numruns 30 &
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/gtr/ --modelN gtr --datasetName primates --filename tree-inference-gtr --lstP 100 1000 10000 --numruns 30 &



# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/jc/ --modelN jc --datasetName M1809 --filename tree-inference --lstP 100 1000 10000 --numruns 30 &
# nohup python scripts/run-plot-transform-results-cppl.py coreppl/models/tree-inference/gtr/ --modelN gtr --datasetName M1809 --filename tree-inference --lstP 100 1000 10000 --numruns 30 &
