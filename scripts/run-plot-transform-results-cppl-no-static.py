...
#python scripts/run-plot-transform-results-cppl-no-static.py coreppl/models/static-delay-paper-experiment/vbd/ --modelN vbd --datasetName vbd --filename vbd --lstPT 3000 30000 300000 --lstP 3000 30000 300000 --numruns 30 &
...
plot_box(norm_auto_dynamic_delayed, "Dynamic pruning",norm_nodelayed, "Nodelay",numparticlesNontransformed)
