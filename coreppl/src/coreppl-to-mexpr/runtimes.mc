...
lang LoadRuntime =
  ...
  sem loadDelayedRuntime: String -> Expr
  sem loadDelayedRuntime =
  | runtime ->
    let parse = use BootParser in parseMCoreFile {
      defaultBootParserParseMCoreFileArg with
        eliminateDeadCode = false,
